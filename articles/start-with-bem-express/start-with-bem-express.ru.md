...
Цель документа — показать, как разрабатывать динамические проекты по БЭМ. После прочтения вы сможете создавать собственные БЭМ-проекты, ориентированные на динамические данные.
