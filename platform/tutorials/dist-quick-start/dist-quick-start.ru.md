...
### Шаг 3. Вставьте блок на страницу

* Откройте страницу с описанием блока из библиотеки bem-components на сайте [bem.info](https://ru.bem.info/platform/libs/bem-components/6.0.0/).
...
* Вставьте код блока в HTML-файл.
...
### Шаг 1. Создайте форму приветствия
...
### Шаг 3. Добавьте блокам функциональность

> **Важно!** Чтобы иметь возможность доопределять JavaScript-реализацию блоков библиотеки, мы подключили бандлы без [автоинициализации](https://ru.bem.info/platform/i-bem/init/) (`*.no-autoinit.js`).
...
### Шаг 1. Подключите бандлы с шаблонизатором
...
### Шаг 2. Добавьте блоки на страницу
...
* [Использование готового HTML](#Использование-готового-html)  
...
* [Генерация HTML в браузере](#Генерация-html-в-браузере)  
