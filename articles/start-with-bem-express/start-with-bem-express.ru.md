...
Прежде чем добавлять новый функционал, давайте изменим структуру взятого за основу приложения [Hello, World](#Приложение-hello-world).
...
3. Введите адрес сервера, например, `https://api.twitter.com/oauth2/token`.
